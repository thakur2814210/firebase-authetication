...
<body>
	...
	<div class="wrapper">
        ...
        <p>Please enter the ID you would like to purchase:</p>
				...
				?>
				<button data-url="<?php echo $url; ?>" id="btnBuyPrem" class="get-started-btn save-settings disabled">Buy BCN</button>
			</div>
		</div>
							...
							<div class="<?php echo $class; ?>">
								<div id="canvas-container">
									...
									<div id="first-drop">
										...
										{
//											$needle = array('ui-draggable', 'ui-draggable-handle', 'ui-resizable');
//											$needle = 'ui-resizable';
//											echo str_replace($needle, '', $widgets_front);
											echo $widgets_front;
										}
										?>
										</div>
										...
										{
										?>
										<div id="back-side-content-id" class="back-side-content" >
										<?php
										}
										?>
										<?php
							...
							<div class="upload-panel" id="background-panel">
								...
								<div class="upload-panel-body">
									<form id="BForm" method="post" action="includes/create-business-card/background_upload.php" enctype="multipart/form-data">
										...
										<button class="upload-background get-started-btn picture-upload editing disabled" id="" onclick="fileUploadBackground(this.form, 'includes/create-business-card/background_upload.php', 'upload_background'); return false;">Upload</button>
...
<?php //if ($_SESSION["card_type"] == 'Personal') {  ?>
									...
									<?php //} else { ?>
									<?php
									if ( lowercase($_SESSION[ "card_type" ]) != 'personal' )
									{
										?>
										<!-- COMPANY WIDGETS -->
...
<?php } ?>
									...
									<?php } ?>
									<?php
									if ( lowercase($_SESSION[ "card_type" ]) == 'product' || lowercase($_SESSION[ "card_type" ]) == 'professional' || lowercase($_SESSION[ "card_type" ]) == 'service' )
									{
										?>
										<!-- DISTRIBUTED BRAND -->
...
<?php include 'includes/footer.php'; ?>
	...
	<script type="text/javascript" src="<?php echo force_reload( 'create-card.js' ); ?>"></script>
