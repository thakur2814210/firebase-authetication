...
<?php require_once('includes/inc_sidebar.php'); ?>
		...
		<div id="main">
			<div class="folder-pages">
				...
				<!--				<div class="card-control-sec">
							<ul class="controls-list">
								...
								</li><li class="show-entries"><a href="#">Show <i>10</i> entries</a>
									<ul class="drop-down">
										...
										<li><a href="#">Entry 7</a></li>
										<li><a href="#">Entry 8</a></li>
										<li><a href="#">Entry 9</a></li>
							...
							<div class="search-field">
								...
								<a href="#" class="searchSecLink"><img src="assets/sat_images/search-icon2.png" alt=""></a>
							</div>
						</div>-->
			...
			<div class="tab-content in_on_request" style="padding-top: 120px !important;">
				...
				<div role="tabpanel" class="tab-pane outgoing-tab" id="outgoing">
