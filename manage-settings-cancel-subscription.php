...
include 'includes/stripe/get_subscription_before_cancellation.php';
?>
			...
			<div class="container">
				<div class="bcn-card-sec">
					<?php if ( $has_subscription ) : ?>
						<div class="price panel-default">
							<div class="panel-heading">
								<strong>
									Cancelling all settings
								</strong>
							</div>
							<div class="panel-body">
								Are you sure you want to unsubscribe from all settings?<br>
								This will cancel your <strong><?php echo $plan->plan_name ?></strong><br>
						...
						<script type="text/javascript">
							jQuery(document).on("click", "#btnContinue", function () {
								jQuery.get("includes/stripe/cancel_subscription.php", {
									subscription:<?php echo $subscription_id; ?>,
									stripe_subscription_id: "<?php echo $stripe_subscription_id; ?>"},
												function (data) {
													loader.show();
					...
					<?php else : ?>
						<script type="text/javascript">
							window.location.href = "manage-your-cards.php";
						</script>
					<?php endif; ?>
