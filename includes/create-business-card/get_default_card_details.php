...
$query = "select
        ...
        inner join default_card dc on dc.card_id = '1'
				left join address pa on u.personal_address_id = pa.address_id left join address ca on u.company_address_id = ca.address_id where u.user_id = '" . $_SESSION[ 'user_id' ] . "'";
