...
//	define( 'API_ACCESS_KEY', 'AIzaSyAxpdnYiSgGMVtIYckiQryDLYVI_zJbSSg' );
...
$query = "SELECT first_name, last_name, email_address, reg_id FROM user WHERE user_id='$recipient_user_id'";
$result = mysqli_query( $conn, $query );
...
$query = "SELECT first_name, last_name, reg_id FROM user WHERE user_id='$user_requested_by'";
$result = mysqli_query( $conn, $query );
$row = mysqli_fetch_row( $result );
...
$query2 = "INSERT INTO notifications (event, event_date, recipient_user_id, active_user_id) VALUES ('$requested_by_first_name $requested_by_last_name added your business card \'$card_name\' ($bcn) to its folder.','$date_string', '$recipient_user_id', '$user_requested_by')";
...
$msg = "$requested_by_first_name $requested_by_last_name has added your Business card '$card_name' with BCN $bcn. Log in at <a href='https://www.cardition.com'>cardition.com</a> to see this card.<br><br>Cardition Staff";
$mailer = new Mailer();
$mail_result = $mailer->send_mail
				(
				"info@cardition.com", "Cardition", $recipient_email, $subject, $msg
);
/*
...
$title = "Card added";
$message = "$requested_by_first_name $requested_by_last_name has added your Business card '$card_name' with BCN $bcn.";
sendPush( $recipient_reg_id, $title, $message );
