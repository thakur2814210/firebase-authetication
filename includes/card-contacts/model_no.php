...
class SearchedCard {
	...
	$card_id, $card_name, $card_type, $canvas_front, $canvas_back, $links_front, $links_back, $company_name, $department_name, $position, $first_name, $last_name, $profile_image, $distributed_brand, $category, $sub_category, $phone, $mobile, $email_address, $title, $website_link, $landscape, $link_status, $settings, $seen_in_user_folder, $average_rating, $bcn) {
		...
		// $this->company_country_id = "GGGG";
		// $this->personal_country_id = "GGGG";
...
class SearchedCardInFolder {
	...
	public function __construct(
	$card_id, $card_name, $card_type, $canvas_front, $canvas_back, $links_front, $links_back, $company_name, $department_name, $position, $first_name, $last_name, $profile_image, $distributed_brand, $category, $sub_category, $phone, $mobile, $email_address, $title, $website_link, $landscape, $link_status, $settings, $seen_in_user_folder, $your_rating, $average_rating, $company_country_id, $personal_country_id = NULL, $bcn = NULL) {
		$this->card_id = $card_id;
		$this->card_name = $card_name;
		$this->card_type = $card_type;
		$this->canvas_front = $canvas_front;
