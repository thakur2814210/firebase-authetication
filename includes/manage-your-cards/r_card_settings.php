<?php
    ...
    if($card_type == "Personal" || $card_type == "Corporate"){
        ...
        $select_query = "SELECT user_id,card_id,global_search,seen_in_user_folder,requires_reciprocity,need_approval FROM personal_card_setting WHERE card_id = '".$card_id."'";
